...
export default function DomainManagementPolicyContent({
  ...
  return (
    <>
      ...
      <p>
        If DOS manages a domain under a Website Care Plan, domain renewal is included only where
        stated in the proposal, invoice, service plan or written agreement. If renewal inclusion is
        not stated, renewal fees, registrar charges and related third-party costs remain separate
        client expenses.
      </p>
